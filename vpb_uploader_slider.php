...
///martin
                ...
                //Pass the attached file to the uploads directory for the first image file
                  ...
                  if ($pos === false) {
                    ...
                    $vpb_uploaded_file_movement_one = $vpb_upload_image_directory . $vpb_image_filename;
                    $vpb_uploaded_file_movement_two = $vpb_upload_image_directory . "original_" .$vpb_image_filename;
                }
                ...
                //			$vpb_uploaded_file_movement_two = $vpb_upload_image_directory."image_original_".rand()."_".$vpb_image_filename;
                ...
                echo '<div class="sliki"><div class="image-cropper  img-polaroid"><input type="hidden" name="imagethumb" value="' . $vpb_uploaded_file_movement_one . '"><input type="hidden" name="image" value="' . $vpb_uploaded_file_movement_two . '"><img class="centered" src="' . $vpb_uploaded_file_movement_one . '"></div></div>';
            }
        }
    }
}
